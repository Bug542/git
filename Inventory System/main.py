...
### tkinter will also be used in order to have control of widgets/buttons that will help with navigating UI 
### tkinter will be used to determine widgets/buttons positions
...
### Table will be created for id,name,price,quantity
...
### if else statement will be used to determine item id this will help insure correct data will be inputed correcly. 
...
### Vizualization of table, Window will display selection of ids, fonts, color, and dimensions will be included. 
...
def delete_data():
    ...
    my_tree.tag_configure('orow', background='#03ffc4')
    my_tree.grid(row=1, column=5, columnspan=4, rowspan=5, padx=10, pady=10)
...
### Buttons with fonts,dimension and color
...
buttonEnter = Button(
    ...
    bd=3, font=('Arial', 15), bg="#8d02ff", command=insert_data)
buttonEnter.grid(row=5, column=1, columnspan=1)

buttonUpdate = Button(
    root, text="Update", padx=5, pady=5, width=5,
    bd=3, font=('Arial', 15), bg="#9ad3ff", command=update_data)
